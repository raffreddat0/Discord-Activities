 ...
 * @author Raffreddat0
 * @updateUrl https://raw.githubusercontent.com/Raffreddat07/Discord-Activities/main/DiscordActivities.plugin.js
 */
/*@cc_on
@if (@_jscript)
	...
	(() => {
		...
		class DiscordActivities extends(external_BasePlugin_default()) {
			...
			enableExperiment() {
				...
				const applicationIds = [app.poker, app.chess, app.betrayal, app.fishing, app.lettertile, app.wordsnack, app.doodlecrew, app.awkword, app.spellcast, app.youtube];
